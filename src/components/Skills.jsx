...
const Skills = () => {
  ...
  return (
    <>
      <section id="skill" className="pt-16 mb-[-100px] sm:pt-10">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16 mt-5">
            <div className="lg:py-12">
              ...
              >
                ...
                seamless user experiences through clean and responsive
                interfaces.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
            <div className="lg:py-12">
              ...
              >
                ...
                captivating experiences, blending creativity and functionality
                for impactful user interfaces.
              </p>
            </div>
            <div className="relative rounded-lg  lg:order-last lg:py-12 lg:ps-48 text-mainBlack dark:text-white">
              <p
